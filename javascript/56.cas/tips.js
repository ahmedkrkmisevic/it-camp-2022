...
// node ima svoje ,mnostvo svojih modula,
// najpoznatiji us fs(fileSystem) i http modul.

// Klase(class)su izrada modela podatka unutar aplikacije (web ili bilo koje druge)
// Svaka klasa mora da ima metodu constructor(){},
// a ona vrsi funkciju glavne funkcije(metode)unutar klase
//pomocu constructor metode se inicijalizuju glavni podaci unutar klase.
// incijalizacija promenljivih i dodela vrednosti njima
// se vrsi pomocu this metode (this.name)
